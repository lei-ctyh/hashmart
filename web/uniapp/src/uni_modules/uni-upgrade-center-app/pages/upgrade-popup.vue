<template>
	<view class="mask flex-center">
		<view class="content botton-radius">
			<image :src="bgUrl" mode="aspectFill" class="bg-img"></image>
			<!-- <img src="../../../static/images/update.png" alt="" class="bg-img"> -->
				...
				<view class="footer flex-center">
					...
					<template v-else>
						<template v-if="!downloadSuccess">
							...
							<button v-else class="content-button now-btn" style="border: none;color: #fff;" plain
								@click="updateApp">
								{{downLoadBtnText}}
							</button>
						</template>
			...
			<image v-if="!is_mandatory" class="close-img" :src="closeUrl" @click.stop="closeUpdate">
			</image>
		</view>
	</view>
</template>
...
<script>
	...
	export default {
		data() {
			return {
				bgUrl: baseUrl.imgroot + '/front/update.png',
				closeUrl: baseUrl.imgroot + '/front/app_update_close.png',
				bg_top: baseUrl.imgroot + '/front/bg_top.png',
				// 从之前下载安装
